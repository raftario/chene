import { C as ComponentType, V as VNode, a as Component, F as FunctionComponent, P as PreactDOMAttributes, b as ClassAttributes, c as ComponentChild, A as Attributes, d as ComponentChildren } from './index.d--r8ZQDVC.js';
export { e as Fragment } from './index.d--r8ZQDVC.js';
...
declare function jsxTemplate(
	template: string[],
	...expressions: any[]
): VNode<any>;
declare function jsxAttr(name: string, value: any): string | null;
declare function jsxEscape<T>(
	value: T
): string | null | VNode<any> | Array<string | null | VNode>;

export { JSXInternal as JSX, jsx, jsxAttr, jsxDEV, jsxEscape, jsxTemplate, jsxs };
