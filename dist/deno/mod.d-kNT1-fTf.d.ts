import { V as VNode } from './index.d-ck3wVEY0.js';
...
declare function json(data: unknown, options?: ResponseInit): Response;
declare function redirect(url: string | URL, status?: 301 | 308): Response;
declare function status(code: number, options?: Omit<ResponseInit, "status">): Response;
